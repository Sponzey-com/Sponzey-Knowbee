...
export type YeonjangRequiredFailureReasonCode =
  | "method_unavailable_or_disconnected"
  | "core_local_path_forbidden"
...
const DEFAULT_NEXT_ACTION =
  "Yeonjang을 연결하거나 해당 기능을 지원하는 인스턴스를 선택한 뒤 다시 실행하세요."

export function buildYeonjangRequiredFailure(input: YeonjangRequiredFailureInput): ToolResult {
