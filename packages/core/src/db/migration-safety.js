const REQUIRED_TABLES = [
    ...
    "rollout_evidence",
    "root_runs",
    "canonical_work_aggregates",
    "canonical_work_receipts",
    "approved_operation_continuations",
    "canonical_pending_responses",
    "side_effect_operations",
    "side_effect_operation_receipts",
    ...
    "agent_relationships",
    "agent_operational_settings_mutation_receipts",
    "run_subsessions",
...
const REQUIRED_INDEXES = [
    ...
    "idx_canonical_work_root_run",
    "idx_canonical_work_receipts_work",
    "idx_canonical_work_receipts_unconsumed",
    "idx_approved_operation_continuations_claim",
    "idx_approved_operation_continuations_run",
    "idx_approval_registry_channel_callback",
    "idx_canonical_pending_responses_status",
    "idx_side_effect_operations_run_state",
    "idx_side_effect_operation_receipts_operation",
    "idx_release_policy_authorizations_binding",
    "idx_performance_acceptance_authorizations_binding",
    "idx_agent_name_namespaces_entity",
    "idx_agent_relationships_parent",
    "idx_agent_operational_settings_mutation_receipts_updated",
