export type YeonjangLiveSmokeState =
  | "prepared"
  | "dispatched"
  | "acknowledged"
  | "observed"
...
export type YeonjangLiveSmokeReadOnlyMethod =
  | "node.capabilities"
  | "system.info"
  | "camera.list"
  | "file.metadata"
...
export const YEONJANG_LIVE_SMOKE_READ_ONLY_METHODS: readonly YeonjangLiveSmokeReadOnlyMethod[] =
  Object.freeze([
    "node.capabilities",
    "system.info",
    "camera.list",
...
export function isYeonjangLiveSmokeReadOnlyMethod(
  value: unknown,
): value is YeonjangLiveSmokeReadOnlyMethod {
  return (
    typeof value === "string" &&
    YEONJANG_LIVE_SMOKE_READ_ONLY_METHODS.includes(value as YeonjangLiveSmokeReadOnlyMethod)
  )
}
...
export type YeonjangLiveSmokeTransitionResult =
  | { ok: true; state: YeonjangLiveSmokeState }
  | { ok: false; state: YeonjangLiveSmokeState; reasonCode: "yeonjang_smoke_transition_invalid" }

const TRANSITIONS: Record<
  string,
  Partial<Record<YeonjangLiveSmokeEvent, YeonjangLiveSmokeState>>
> = {
...
export function transitionYeonjangLiveSmokeState(
  state: YeonjangLiveSmokeState,
  event: YeonjangLiveSmokeEvent,
): YeonjangLiveSmokeTransitionResult {
