import { createWebResearchSnapshot, } from "../contracts/web-research-method.js";
import { executeWebResearchMethodProposal } from "./web-research-method-use-case.js";
export async function executeWebResearchTerminalProposal(input) {
    if (!input.runId.trim() || input.evidenceRefs.length === 0) {
        return Object.freeze({
            ok: false,
            reasonCode: "web_research_terminal_context_invalid",
        });
    }
...
//# sourceMappingURL=web-research-terminal-use-case.js.map