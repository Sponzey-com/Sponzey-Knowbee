import { CAPABILITY_SELECTION_DECISION_TRACE_SCHEMA_VERSION, parseCapabilitySelectionDecisionTraceDetail, } from "../contracts/capability-selection-decision-trace.js";
...
export function createSqliteCapabilitySelectionDecisionTraceSink(input) {
    return {
        record(record) {
            if (!SAFE_REFERENCE.test(record.runId) ||
...
//# sourceMappingURL=capability-selection-decision-trace-adapter.js.map