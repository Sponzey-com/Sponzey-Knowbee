...
export type ApprovedOperationContinuationStatus =
  | "pending"
  | "claimed"
  | "completed"
  | "cancelled"
...
export type EnqueueApprovedOperationContinuationResult =
  ...
  | {
      ...
      readonly reasonCode:
        | "approval_continuation_source_invalid"
        | "approval_continuation_identity_conflict"
    }
...
export type CompleteApprovedOperationContinuationResult =
  ...
  | {
      readonly status: "rejected"
      readonly reasonCode:
        | "approval_continuation_not_found"
        | "approval_continuation_claim_mismatch"
    }
...
export function approvedOperationContinuationId(approvalId: string): string {
