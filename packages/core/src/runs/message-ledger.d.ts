...
export declare function reserveIngressAdmission(input: {
    idempotencyKey: string;
    runId: string;
    sessionId: string;
    source: string;
}): IngressAdmissionReservation;
export declare function evaluatePersistedWebRetrievalTransition(input: {
...
export declare function reserveMessageDeliveryAdmission(input: Omit<MessageLedgerEventInput, "eventKind" | "status" | "summary">): MessageDeliveryAdmissionResult;
export declare function completeMessageDeliveryAdmission(input: {
    idempotencyKey: string;
    delivered: boolean;
    detail?: Record<string, unknown>;
}): boolean;
export declare function cancelMessageDeliveryAdmission(input: {
    idempotencyKey: string;
    detail?: Record<string, unknown>;
}): boolean;
...
export declare function rejectsDuplicateAsUnchangedRecovery(toolName: string): boolean;
...
export declare function messageLedgerEventHasRequiredDeliveryEvidence(event: DbMessageLedgerEvent | null | undefined): boolean;
