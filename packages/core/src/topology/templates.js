    ...
    nodePresets: [
        {
            ...
            labelKo: "서브 에이전트",
            labelEn: "Sub-agent",
            descriptionKo: "가장 기본적인 서브 에이전트",
            descriptionEn: "Default sub-agent for a flow",
            nodeType: "function",
            defaultNameKo: "새 서브 에이전트",
            defaultNameEn: "New sub-agent",
        ...
        },
        {
            ...
            labelKo: "검토 서브 에이전트",
            labelEn: "Review sub-agent",
            descriptionKo: "결과를 확인하고 다음 서브 에이전트로 넘기는 역할",
            descriptionEn: "Sub-agent for review before moving forward",
            nodeType: "review_node",
            defaultNameKo: "새 검토 서브 에이전트",
            defaultNameEn: "New review sub-agent",
        ...
        },
        {
            ...
            labelKo: "자동화 서브 에이전트",
            labelEn: "Automation sub-agent",
            descriptionKo: "시스템 또는 도구를 사용하는 서브 에이전트",
            descriptionEn: "Sub-agent centered on system or tool use",
            nodeType: "automation_node",
            defaultNameKo: "새 자동화 서브 에이전트",
            defaultNameEn: "New automation sub-agent",
