...
const RELATION_TEMPLATE_META = {
    ...
    uses_tool: {
        ...
        labelKo: "도구 사용",
        labelEn: "Uses tool",
        descriptionKo: "서브 에이전트가 도구를 사용",
        descriptionEn: "Sub-agent uses a tool",
        group: "primary",
        layer: "technical",
        runtimeCandidate: false,
        easyLabelKo: "사용",
    ...
    uses_system: {
        ...
        labelKo: "시스템 사용",
        labelEn: "Uses system",
        descriptionKo: "서브 에이전트 또는 프로세스가 시스템을 사용",
        descriptionEn: "Sub-agent or process uses a system",
        group: "primary",
        layer: "technical",
        runtimeCandidate: false,
        easyLabelKo: "사용",
