import { type TypedObservabilityEvent, type TypedObservabilityEventRejectionReason } from "./typed-event-contract.js";
...
export type TypedObservabilityStoredIssueCode = "schema_version_unsupported" | "stored_payload_invalid" | "stored_event_invalid";
...
export type TypedObservabilityAppendResult = {
    ...
    status: "rejected";
    reasonCode: TypedObservabilityEventRejectionReason | "event_id_conflict";
};
...
export type RecordTypedObservabilityEventReceipt = TypedObservabilityAppendResult | {
    status: "degraded";
    reasonCode: "repository_write_failed";
};
export declare function recordTypedObservabilityEventSafely(input: {
...
//# sourceMappingURL=typed-event-repository.d.ts.map