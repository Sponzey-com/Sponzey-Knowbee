import { validatePromptImprovementRollbackSource, } from "./prompt-rollback-source-policy.js";
...
export function authorizePromptChangeRollbackReadiness(input) {
    ...
    if (!PROMPT_ROLLBACK_VERIFICATION_METHODS.includes(input.rollback.verificationMethod)) {
    ...
    return {
        ...
        verificationMethod: input.rollback.verificationMethod,
        evidenceRef: input.rollback.evidenceRef,
    };
}
//# sourceMappingURL=prompt-change-rollback-readiness.js.map