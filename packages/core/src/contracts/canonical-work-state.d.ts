export declare const CANONICAL_WORK_STATES: readonly ["REQUEST_RECEIVED", "SOLUTION_ANALYZED", "POLICY_VALIDATED", "EXECUTING", "RESULT_REVIEW", "SUCCEEDED", "PARTIALLY_SUCCEEDED", "USER_INPUT_REQUIRED", "BLOCKED", "EXHAUSTED", "CANCELLED", "USER_REPORT"];
