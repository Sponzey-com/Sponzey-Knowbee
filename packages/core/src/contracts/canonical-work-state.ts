...
export const CANONICAL_WORK_TRANSITIONS: Readonly<Record<CanonicalWorkState, StateTransitions>> = Object.freeze({
...
export function transitionCanonicalWorkState(
  command: CanonicalWorkTransitionCommand,
): CanonicalWorkTransitionDecision {
