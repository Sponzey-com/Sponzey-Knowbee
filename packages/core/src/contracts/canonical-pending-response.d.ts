export type CanonicalPendingResponseTextSource = "llm_generated" | "llm_reviewed" | "runtime_deterministic" | "user_supplied_literal" | "mixed";
export type CanonicalPendingResponseFinalOutcome = "succeeded" | "partial" | "blocked" | "exhausted" | "cancelled";
export type CanonicalPendingResponseContentKind = "direct_answer" | "planning" | "delegation" | "tool_result" | "yeonjang_result" | "sub_agent_result" | "prompt_improvement" | "final_report" | "safety_notice" | "system_status" | "validation_error" | "fixed_notice";
...
export type CanonicalPendingResponseReviewReceipt = CanonicalPendingResponseReviewReceiptV1 | CanonicalPendingResponseReviewReceiptV2;
...
export type CanonicalPendingResponseReviewIssue = "review_envelope_missing" | "review_envelope_invalid" | "review_envelope_response_mismatch" | "review_envelope_terminal_report_missing";
...
//# sourceMappingURL=canonical-pending-response.d.ts.map