...
} from "./yeonjang-browser-active-tab-info-final-audit-release-closure-ledger.js"

export type YeonjangBrowserActiveTabInfoOperatorReleaseArchiveCompletionNoticeStatus = "ready"

export type YeonjangBrowserActiveTabInfoOperatorReleaseArchiveCompletionNoticeBlockingReasonCode =
...
export type YeonjangBrowserActiveTabInfoOperatorReleaseArchiveCompletionNotice = Readonly<{
  ...
  reasonCode:
    | "active_tab_info_operator_release_archive_completion_notice_ready"
...
const SAFE_ARCHIVE_COMPLETION_NOTICE_REF_PATTERN =
  /^archive-completion-notice:active-tab-info:sanitized:[a-z0-9._:-]+$/u

const SAFE_PRODUCT_LOG_EVIDENCE_REF_PATTERN =
  /^product-log:active-tab-info:evidence:[a-z0-9._:-]+$/u

const SAFE_OPERATOR_ARCHIVE_ACK_REF_PATTERN =
  /^operator-archive:active-tab-info:ack:[a-z0-9._:-]+$/u

function extractFinalAuditReleaseClosureLedgerId(
  ledger: YeonjangBrowserActiveTabInfoFinalAuditReleaseClosureLedger,
): string | undefined {
...
function baseResult(input: {
  status: YeonjangBrowserActiveTabInfoOperatorReleaseArchiveCompletionNotice["status"]
  reasonCode: YeonjangBrowserActiveTabInfoOperatorReleaseArchiveCompletionNotice["reasonCode"]
  blockingReasonCodes?: readonly YeonjangBrowserActiveTabInfoOperatorReleaseArchiveCompletionNoticeBlockingReasonCode[]
  notice?: YeonjangBrowserActiveTabInfoOperatorReleaseArchiveCompletionNotice["notice"]
...
export function buildYeonjangBrowserActiveTabInfoOperatorReleaseArchiveCompletionNotice(
  input: YeonjangBrowserActiveTabInfoOperatorReleaseArchiveCompletionNoticeInput,
): YeonjangBrowserActiveTabInfoOperatorReleaseArchiveCompletionNotice {
  const blockingReasonCodes: YeonjangBrowserActiveTabInfoOperatorReleaseArchiveCompletionNoticeBlockingReasonCode[] = []
  const finalAuditReleaseClosureLedgerId = extractFinalAuditReleaseClosureLedgerId(
    input.finalAuditReleaseClosureLedger,
  )
