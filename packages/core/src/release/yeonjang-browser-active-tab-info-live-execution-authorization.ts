...
} from "./yeonjang-browser-active-tab-info-runtime-mutation-dry-run-receipt.js"
...
export type YeonjangBrowserActiveTabInfoLiveExecutionAuthorizationBlockingReasonCode =
  ...
  | "live_execution_authorization_surface_count_mismatch"
  ...
  | "live_execution_authorization_expires_at_invalid"
...
export type YeonjangBrowserActiveTabInfoLiveExecutionAuthorization = Readonly<{
  ...
  reasonCode:
    | "active_tab_info_live_execution_authorization_ready"
    | "active_tab_info_live_execution_authorization_blocked"
...
function baseResult(input: {
  status: YeonjangBrowserActiveTabInfoLiveExecutionAuthorization["status"]
  reasonCode: YeonjangBrowserActiveTabInfoLiveExecutionAuthorization["reasonCode"]
  blockingReasonCodes?: readonly YeonjangBrowserActiveTabInfoLiveExecutionAuthorizationBlockingReasonCode[]
  authorization?: YeonjangBrowserActiveTabInfoLiveExecutionAuthorization["authorization"]
...
export function buildYeonjangBrowserActiveTabInfoLiveExecutionAuthorization(
  input: YeonjangBrowserActiveTabInfoLiveExecutionAuthorizationInput,
  options: YeonjangBrowserActiveTabInfoLiveExecutionAuthorizationOptions,
): YeonjangBrowserActiveTabInfoLiveExecutionAuthorization {
  const blockingReasonCodes: YeonjangBrowserActiveTabInfoLiveExecutionAuthorizationBlockingReasonCode[] = []
