...
const SAFE_ARCHIVAL_COMPLETION_ACKNOWLEDGEMENT_REF_PATTERN = /^archival-completion-acknowledgement:active-tab-info:sanitized:[a-z0-9._:-]+$/u;
const SAFE_PRODUCT_LOG_EVIDENCE_REF_PATTERN = /^product-log:active-tab-info:evidence:[a-z0-9._:-]+$/u;
const SAFE_OPERATOR_ARCHIVAL_COMPLETION_ACK_REF_PATTERN = /^operator-archival-completion:active-tab-info:ack:[a-z0-9._:-]+$/u;
function extractFinalArchivalCompletionIndexId(index) {
...
export function buildYeonjangBrowserActiveTabInfoOperatorArchivalCompletionAcknowledgementReceipt(input) {
    const blockingReasonCodes = [];
    const finalArchivalCompletionIndexId = extractFinalArchivalCompletionIndexId(input.finalArchivalCompletionIndex);
    ...
    const sanitizedArchivalCompletionAcknowledgementRef = input.sanitizedArchivalCompletionAcknowledgementRef.trim();
    ...
    const operatorArchivalCompletionAcknowledgementRef = input.operatorArchivalCompletionAcknowledgementRef.trim();
    ...
    return baseResult({
        ...
        receipt: Object.freeze({
            operatorArchivalCompletionAcknowledgementReceiptId: buildOperatorArchivalCompletionAcknowledgementReceiptId({
...
//# sourceMappingURL=yeonjang-browser-active-tab-info-operator-archival-completion-acknowledgement-receipt.js.map