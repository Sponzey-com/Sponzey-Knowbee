...
} from "./yeonjang-browser-active-tab-info-operator-final-retained-acknowledgement-completion-closeout-receipt.js"

export type YeonjangBrowserActiveTabInfoFinalRetainedAcknowledgementCompletionCloseoutLedgerStatus =
  "ready"

export type YeonjangBrowserActiveTabInfoFinalRetainedAcknowledgementCompletionCloseoutLedgerBlockingReasonCode =
...
const SAFE_FINAL_RETAINED_ACKNOWLEDGEMENT_COMPLETION_CLOSEOUT_LEDGER_REF_PATTERN =
  /^final-retained-acknowledgement-completion-closeout-ledger:active-tab-info:sanitized:[a-z0-9._:-]+$/u

const SAFE_PRODUCT_LOG_EVIDENCE_REF_PATTERN =
  /^product-log:active-tab-info:evidence:[a-z0-9._:-]+$/u

const SAFE_FINAL_RETAINED_ACKNOWLEDGEMENT_COMPLETION_CLOSEOUT_REF_PATTERN =
  /^final-retained-acknowledgement-completion-closeout:active-tab-info:ack:[a-z0-9._:-]+$/u

function extractOperatorFinalRetainedAcknowledgementCompletionCloseoutReceiptId(
  receipt: YeonjangBrowserActiveTabInfoOperatorFinalRetainedAcknowledgementCompletionCloseoutReceipt,
): string | undefined {
  if (
    receipt.status !==
...
function baseResult(input: {
  status: YeonjangBrowserActiveTabInfoFinalRetainedAcknowledgementCompletionCloseoutLedger["status"]
  reasonCode: YeonjangBrowserActiveTabInfoFinalRetainedAcknowledgementCompletionCloseoutLedger["reasonCode"]
  blockingReasonCodes?: readonly YeonjangBrowserActiveTabInfoFinalRetainedAcknowledgementCompletionCloseoutLedgerBlockingReasonCode[]
  ledger?: YeonjangBrowserActiveTabInfoFinalRetainedAcknowledgementCompletionCloseoutLedger["ledger"]
...
export function buildYeonjangBrowserActiveTabInfoFinalRetainedAcknowledgementCompletionCloseoutLedger(
  input: YeonjangBrowserActiveTabInfoFinalRetainedAcknowledgementCompletionCloseoutLedgerInput,
): YeonjangBrowserActiveTabInfoFinalRetainedAcknowledgementCompletionCloseoutLedger {
  const blockingReasonCodes: YeonjangBrowserActiveTabInfoFinalRetainedAcknowledgementCompletionCloseoutLedgerBlockingReasonCode[] = []
  const operatorFinalRetainedAcknowledgementCompletionCloseoutReceiptId =
    extractOperatorFinalRetainedAcknowledgementCompletionCloseoutReceiptId(
      input.operatorFinalRetainedAcknowledgementCompletionCloseoutReceipt,
    )
  ...
  const sanitizedFinalRetainedAcknowledgementCompletionCloseoutLedgerRef =
    input.sanitizedFinalRetainedAcknowledgementCompletionCloseoutLedgerRef.trim()
  ...
  const finalRetainedAcknowledgementCompletionCloseoutRef =
    input.finalRetainedAcknowledgementCompletionCloseoutRef.trim()
  ...
  return baseResult({
    ...
    ledger: Object.freeze({
      finalRetainedAcknowledgementCompletionCloseoutLedgerId:
        buildFinalRetainedAcknowledgementCompletionCloseoutLedgerId({
