...
} from "./yeonjang-browser-active-tab-info-user-goal-closeout-receipt.js"

export type YeonjangBrowserActiveTabInfoCompletionStatus = "closed"

export type YeonjangBrowserActiveTabInfoCompletionAuditSummaryBlockingReasonCode =
...
export type YeonjangBrowserActiveTabInfoCompletionAuditSummary = Readonly<{
  ...
  reasonCode:
    | "active_tab_info_completion_audit_summary_ready"
    | "active_tab_info_completion_audit_summary_blocked"
...
const SAFE_FINAL_RESULT_PROJECTION_REF_PATTERN =
  /^final-result-projection:active-tab-info:redacted:[a-z0-9._:-]+$/u

const SAFE_PRODUCT_LOG_EVIDENCE_REF_PATTERN =
  /^product-log:active-tab-info:evidence:[a-z0-9._:-]+$/u

const SAFE_OPERATOR_COMPLETION_NOTE_REF_PATTERN =
  /^operator-completion-note:active-tab-info:sanitized:[a-z0-9._:-]+$/u

function extractCloseoutReceiptId(
  receipt: YeonjangBrowserActiveTabInfoUserGoalCloseoutReceipt,
): string | undefined {
...
function baseResult(input: {
  status: YeonjangBrowserActiveTabInfoCompletionAuditSummary["status"]
  reasonCode: YeonjangBrowserActiveTabInfoCompletionAuditSummary["reasonCode"]
  blockingReasonCodes?: readonly YeonjangBrowserActiveTabInfoCompletionAuditSummaryBlockingReasonCode[]
  summary?: YeonjangBrowserActiveTabInfoCompletionAuditSummary["summary"]
...
export function buildYeonjangBrowserActiveTabInfoCompletionAuditSummary(
  input: YeonjangBrowserActiveTabInfoCompletionAuditSummaryInput,
): YeonjangBrowserActiveTabInfoCompletionAuditSummary {
  const blockingReasonCodes: YeonjangBrowserActiveTabInfoCompletionAuditSummaryBlockingReasonCode[] = []
