...
} from "./yeonjang-browser-active-tab-info-release-evidence-chain-cleanup-deletion-candidate-plan.ts"
...
export type YeonjangBrowserActiveTabInfoReleaseEvidenceChainCleanupDeletionReviewReceipt = {
  ...
  readonly nextAllowedAction:
    ...
    | "complete_cleanup_deletion_candidate_plan"
    | "provide_cleanup_deletion_review_receipt_ref"
...
const SAFE_OPERATOR_REVIEW_RECEIPT_REF =
  /^cleanup-deletion-review-receipt:active-tab-info:sanitized:[a-z0-9][a-z0-9:-]{0,96}$/u
...
function blocked(input: {
  reasonCode: Exclude<
    ...
    "active_tab_info_release_evidence_chain_cleanup_deletion_review_receipt_accepted"
  >
  reviewedCandidatePlanStatus: "ready" | "blocked"
  nextAllowedAction: Extract<
    YeonjangBrowserActiveTabInfoReleaseEvidenceChainCleanupDeletionReviewReceipt["nextAllowedAction"],
    "complete_cleanup_deletion_candidate_plan" | "provide_cleanup_deletion_review_receipt_ref"
  >
...
export function buildYeonjangBrowserActiveTabInfoReleaseEvidenceChainCleanupDeletionReviewReceipt(
  input: YeonjangBrowserActiveTabInfoReleaseEvidenceChainCleanupDeletionReviewReceiptInput,
): YeonjangBrowserActiveTabInfoReleaseEvidenceChainCleanupDeletionReviewReceipt {
  if (
    input.cleanupDeletionCandidatePlan.candidatePlanStatus !== "ready" ||
