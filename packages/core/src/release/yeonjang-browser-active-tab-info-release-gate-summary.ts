...
export type YeonjangBrowserActiveTabInfoReleaseGateId =
...
export type YeonjangBrowserActiveTabInfoReleaseGateStatus =
...
const REQUIRED_GATE_IDS: YeonjangBrowserActiveTabInfoReleaseGateId[] = [
  "readiness_projection",
  "pre_dispatch_bridge",
  "rust_inventory_contract",
  "audit_evidence_boundary",
...
export function buildYeonjangBrowserActiveTabInfoReleaseGateSummary(
  input: YeonjangBrowserActiveTabInfoReleaseGateSummaryInput,
): YeonjangBrowserActiveTabInfoReleaseGateSummary {
  const readinessByGate = new Map<YeonjangBrowserActiveTabInfoReleaseGateId, boolean>([
