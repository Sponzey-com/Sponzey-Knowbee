...
} from "./yeonjang-browser-active-tab-info-final-closeout-ledger.js"

export type YeonjangBrowserActiveTabInfoFinalAuditHandoffStatus = "handoff_ready"

export type YeonjangBrowserActiveTabInfoFinalAuditHandoffBundleBlockingReasonCode =
...
export type YeonjangBrowserActiveTabInfoFinalAuditHandoffBundle = Readonly<{
  ...
  reasonCode:
    | "active_tab_info_final_audit_handoff_bundle_ready"
    | "active_tab_info_final_audit_handoff_bundle_blocked"
...
const SAFE_AUDIT_ARTIFACT_DESCRIPTOR_REF_PATTERN =
  /^audit-artifact-descriptor:active-tab-info:sanitized:[a-z0-9._:-]+$/u

const SAFE_PRODUCT_LOG_EVIDENCE_REF_PATTERN =
  /^product-log:active-tab-info:evidence:[a-z0-9._:-]+$/u

const SAFE_RELEASE_SURFACE_MATRIX_ACK_REF_PATTERN =
  /^release-surface-matrix:active-tab-info:ack:[a-z0-9._:-]+$/u

function extractFinalCloseoutLedgerId(
  ledger: YeonjangBrowserActiveTabInfoFinalCloseoutLedger,
): string | undefined {
...
function baseResult(input: {
  status: YeonjangBrowserActiveTabInfoFinalAuditHandoffBundle["status"]
  reasonCode: YeonjangBrowserActiveTabInfoFinalAuditHandoffBundle["reasonCode"]
  blockingReasonCodes?: readonly YeonjangBrowserActiveTabInfoFinalAuditHandoffBundleBlockingReasonCode[]
  bundle?: YeonjangBrowserActiveTabInfoFinalAuditHandoffBundle["bundle"]
...
export function buildYeonjangBrowserActiveTabInfoFinalAuditHandoffBundle(
  input: YeonjangBrowserActiveTabInfoFinalAuditHandoffBundleInput,
): YeonjangBrowserActiveTabInfoFinalAuditHandoffBundle {
  const blockingReasonCodes: YeonjangBrowserActiveTabInfoFinalAuditHandoffBundleBlockingReasonCode[] = []
