...
const SAFE_ARCHIVE_DESCRIPTOR_REF_PATTERN = /^archive-descriptor:active-tab-info:sanitized:[a-z0-9._:-]+$/u;
const SAFE_PRODUCT_LOG_EVIDENCE_REF_PATTERN = /^product-log:active-tab-info:evidence:[a-z0-9._:-]+$/u;
const SAFE_RETENTION_POLICY_ACK_REF_PATTERN = /^retention-policy:active-tab-info:ack:[a-z0-9._:-]+$/u;
function extractOperatorReadableCloseoutSummaryId(summary) {
...
export function buildYeonjangBrowserActiveTabInfoFinalArchivalPointer(input) {
    const blockingReasonCodes = [];
    const operatorReadableCloseoutSummaryId = extractOperatorReadableCloseoutSummaryId(input.operatorReadableCloseoutSummary);
...
//# sourceMappingURL=yeonjang-browser-active-tab-info-final-archival-pointer.js.map