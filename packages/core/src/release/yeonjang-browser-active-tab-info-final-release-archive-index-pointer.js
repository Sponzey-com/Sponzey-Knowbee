...
const SAFE_RELEASE_ARCHIVE_INDEX_POINTER_REF_PATTERN = /^release-archive-index-pointer:active-tab-info:sanitized:[a-z0-9._:-]+$/u;
const SAFE_PRODUCT_LOG_EVIDENCE_REF_PATTERN = /^product-log:active-tab-info:evidence:[a-z0-9._:-]+$/u;
const SAFE_ARCHIVE_INDEX_RETENTION_ACK_REF_PATTERN = /^archive-index-retention:active-tab-info:ack:[a-z0-9._:-]+$/u;
function extractOperatorReleaseArchiveCompletionNoticeId(notice) {
...
export function buildYeonjangBrowserActiveTabInfoFinalReleaseArchiveIndexPointer(input) {
    const blockingReasonCodes = [];
    const operatorReleaseArchiveCompletionNoticeId = extractOperatorReleaseArchiveCompletionNoticeId(input.operatorReleaseArchiveCompletionNotice);
    ...
    const sanitizedReleaseArchiveIndexPointerRef = input.sanitizedReleaseArchiveIndexPointerRef.trim();
    ...
    const archiveIndexRetentionAcknowledgementRef = input.archiveIndexRetentionAcknowledgementRef.trim();
...
//# sourceMappingURL=yeonjang-browser-active-tab-info-final-release-archive-index-pointer.js.map