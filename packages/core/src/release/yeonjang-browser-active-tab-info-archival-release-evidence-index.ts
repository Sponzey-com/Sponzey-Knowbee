...
} from "./yeonjang-browser-active-tab-info-final-archival-pointer.js"
...
export type YeonjangBrowserActiveTabInfoArchivalReleaseEvidenceIndex = Readonly<{
  ...
  reasonCode:
    | "active_tab_info_archival_release_evidence_index_ready"
    | "active_tab_info_archival_release_evidence_index_blocked"
...
const SAFE_EVIDENCE_INDEX_REF_PATTERN =
  /^archival-evidence-index:active-tab-info:sanitized:[a-z0-9._:-]+$/u

const SAFE_PRODUCT_LOG_EVIDENCE_REF_PATTERN =
  /^product-log:active-tab-info:evidence:[a-z0-9._:-]+$/u

const SAFE_AUDIT_RETRIEVAL_ACK_REF_PATTERN =
  /^audit-retrieval:active-tab-info:ack:[a-z0-9._:-]+$/u

function extractFinalArchivalPointerId(
  pointer: YeonjangBrowserActiveTabInfoFinalArchivalPointer,
): string | undefined {
...
function baseResult(input: {
  status: YeonjangBrowserActiveTabInfoArchivalReleaseEvidenceIndex["status"]
  reasonCode: YeonjangBrowserActiveTabInfoArchivalReleaseEvidenceIndex["reasonCode"]
  blockingReasonCodes?: readonly YeonjangBrowserActiveTabInfoArchivalReleaseEvidenceIndexBlockingReasonCode[]
  index?: YeonjangBrowserActiveTabInfoArchivalReleaseEvidenceIndex["index"]
...
export function buildYeonjangBrowserActiveTabInfoArchivalReleaseEvidenceIndex(
  input: YeonjangBrowserActiveTabInfoArchivalReleaseEvidenceIndexInput,
): YeonjangBrowserActiveTabInfoArchivalReleaseEvidenceIndex {
  const blockingReasonCodes: YeonjangBrowserActiveTabInfoArchivalReleaseEvidenceIndexBlockingReasonCode[] = []
