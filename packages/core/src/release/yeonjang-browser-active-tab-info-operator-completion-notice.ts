...
} from "./yeonjang-browser-active-tab-info-final-audit-handoff-bundle.js"

export type YeonjangBrowserActiveTabInfoOperatorCompletionNoticeStatus = "ready"

export type YeonjangBrowserActiveTabInfoOperatorCompletionNoticeBlockingReasonCode =
...
export type YeonjangBrowserActiveTabInfoOperatorCompletionNotice = Readonly<{
  ...
  reasonCode:
    | "active_tab_info_operator_completion_notice_ready"
    | "active_tab_info_operator_completion_notice_blocked"
...
const SAFE_OPERATOR_NOTICE_REF_PATTERN =
  /^operator-completion-notice:active-tab-info:sanitized:[a-z0-9._:-]+$/u

const SAFE_PRODUCT_LOG_EVIDENCE_REF_PATTERN =
  /^product-log:active-tab-info:evidence:[a-z0-9._:-]+$/u

const SAFE_USER_VISIBLE_RESPONSE_ACK_REF_PATTERN =
  /^user-visible-response:active-tab-info:ack:[a-z0-9._:-]+$/u

function extractFinalAuditHandoffBundleId(
  bundle: YeonjangBrowserActiveTabInfoFinalAuditHandoffBundle,
): string | undefined {
...
function baseResult(input: {
  status: YeonjangBrowserActiveTabInfoOperatorCompletionNotice["status"]
  reasonCode: YeonjangBrowserActiveTabInfoOperatorCompletionNotice["reasonCode"]
  blockingReasonCodes?: readonly YeonjangBrowserActiveTabInfoOperatorCompletionNoticeBlockingReasonCode[]
  notice?: YeonjangBrowserActiveTabInfoOperatorCompletionNotice["notice"]
...
export function buildYeonjangBrowserActiveTabInfoOperatorCompletionNotice(
  input: YeonjangBrowserActiveTabInfoOperatorCompletionNoticeInput,
): YeonjangBrowserActiveTabInfoOperatorCompletionNotice {
  const blockingReasonCodes: YeonjangBrowserActiveTabInfoOperatorCompletionNoticeBlockingReasonCode[] = []
