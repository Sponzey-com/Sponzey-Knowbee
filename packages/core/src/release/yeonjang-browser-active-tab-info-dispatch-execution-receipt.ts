...
} from "./yeonjang-browser-active-tab-info-dispatch-dry-run-receipt.js"
...
export type YeonjangBrowserActiveTabInfoDispatchExecutionReceipt = Readonly<{
  ...
  reasonCode:
    | "active_tab_info_dispatch_execution_receipt_ready"
    | "active_tab_info_dispatch_execution_receipt_blocked"
...
function baseResult(input: {
  status: YeonjangBrowserActiveTabInfoDispatchExecutionReceipt["status"]
  reasonCode: YeonjangBrowserActiveTabInfoDispatchExecutionReceipt["reasonCode"]
  blockingReasonCodes?: readonly YeonjangBrowserActiveTabInfoDispatchExecutionReceiptBlockingReasonCode[]
  receipt?: YeonjangBrowserActiveTabInfoDispatchExecutionReceipt["receipt"]
...
export function buildYeonjangBrowserActiveTabInfoDispatchExecutionReceipt(
  input: YeonjangBrowserActiveTabInfoDispatchExecutionReceiptInput,
): YeonjangBrowserActiveTabInfoDispatchExecutionReceipt {
  const blockingReasonCodes: YeonjangBrowserActiveTabInfoDispatchExecutionReceiptBlockingReasonCode[] = []
