...
function makeRegistryInstance(input) {
...
function buildSyntheticRegistryInstances() {
    return [
...
function checkExactTarget(instances) {
...
function checkAmbiguousLocal(instances) {
    const selection = resolveYeonjangTargetSelection({
...
function checkRevokedTarget(instances) {
    const selection = resolveYeonjangTargetSelection({
...
function checkBroadcastApproval(instances) {
...
function checkIdempotencyDelivery() {
...
function checkDuplicateSessionGuard(instances) {
    const selection = resolveYeonjangTargetSelection({
...
function buildManualSmokeChecklist() {
    return [
        {
            id: "macos",
...
//# sourceMappingURL=yeonjang-multi-instance-gate.js.map