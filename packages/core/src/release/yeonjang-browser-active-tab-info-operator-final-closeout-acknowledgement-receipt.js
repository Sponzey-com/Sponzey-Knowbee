...
const SAFE_OPERATOR_FINAL_CLOSEOUT_ACKNOWLEDGEMENT_RECEIPT_REF_PATTERN = /^operator-final-closeout-acknowledgement-receipt:active-tab-info:sanitized:[a-z0-9._:-]+$/u;
const SAFE_PRODUCT_LOG_EVIDENCE_REF_PATTERN = /^product-log:active-tab-info:evidence:[a-z0-9._:-]+$/u;
const SAFE_OPERATOR_FINAL_CLOSEOUT_ACKNOWLEDGEMENT_RECEIPT_ACK_REF_PATTERN = /^operator-final-closeout:active-tab-info:receipt:[a-z0-9._:-]+$/u;
function extractFinalSealedArchiveCloseoutLedgerId(ledger) {
    if (ledger.status !== "final_sealed_archive_closeout_ledger_ready" ||
...
export function buildYeonjangBrowserActiveTabInfoOperatorFinalCloseoutAcknowledgementReceipt(input) {
    const blockingReasonCodes = [];
    const finalSealedArchiveCloseoutLedgerId = extractFinalSealedArchiveCloseoutLedgerId(input.finalSealedArchiveCloseoutLedger);
    ...
    const sanitizedOperatorFinalCloseoutAcknowledgementReceiptRef = input.sanitizedOperatorFinalCloseoutAcknowledgementReceiptRef.trim();
    ...
    const operatorFinalCloseoutAcknowledgementReceiptRef = input.operatorFinalCloseoutAcknowledgementReceiptRef.trim();
    ...
    return baseResult({
        ...
        receipt: Object.freeze({
            operatorFinalCloseoutAcknowledgementReceiptId: buildOperatorFinalCloseoutAcknowledgementReceiptId({
...
//# sourceMappingURL=yeonjang-browser-active-tab-info-operator-final-closeout-acknowledgement-receipt.js.map