...
const SAFE_ARCHIVED_RELEASE_ACKNOWLEDGEMENT_REF_PATTERN = /^archived-release-acknowledgement:active-tab-info:sanitized:[a-z0-9._:-]+$/u;
const SAFE_PRODUCT_LOG_EVIDENCE_REF_PATTERN = /^product-log:active-tab-info:evidence:[a-z0-9._:-]+$/u;
const SAFE_OPERATOR_ARCHIVED_RELEASE_ACK_REF_PATTERN = /^operator-archived-release:active-tab-info:ack:[a-z0-9._:-]+$/u;
function extractFinalArchivedReleaseClosureMarkerId(marker) {
...
export function buildYeonjangBrowserActiveTabInfoOperatorArchivedReleaseAcknowledgement(input) {
    const blockingReasonCodes = [];
    const finalArchivedReleaseClosureMarkerId = extractFinalArchivedReleaseClosureMarkerId(input.finalArchivedReleaseClosureMarker);
    ...
    const sanitizedArchivedReleaseAcknowledgementRef = input.sanitizedArchivedReleaseAcknowledgementRef.trim();
    ...
    const operatorArchivedReleaseAcknowledgementRef = input.operatorArchivedReleaseAcknowledgementRef.trim();
...
//# sourceMappingURL=yeonjang-browser-active-tab-info-operator-archived-release-acknowledgement.js.map