...
function recoveryReviewSummary(key: RecoveryReviewSummaryKey): string {
  ...
  if (!value) throw new Error(`topology recovery review summary missing: ${key}`)
  return value
}
