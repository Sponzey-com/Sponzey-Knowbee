...
export declare const AgentExecutionFallbackReason: {
    ...
    readonly RootKnowbeeDirect: "root_knowbee_direct";
    ...
    readonly KnowbeeDirect: "knowbee_direct";
...
export declare const AGENT_EXECUTION_ROUTES: readonly ["self_solve", "direct_current_agent", "delegate_to_child", "return_to_parent", "root_knowbee_direct", "explicit_provider", "explicit_provider_target", "boundary_failure", "knowbee_direct", "ask_parent", "ask_user", "sub_agent", "yeonjang"];
