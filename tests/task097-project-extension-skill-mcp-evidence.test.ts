...
const requirementIds = ["PRJ-38509ae9", "PRJ-7bfe7a20", "PRJ-67447f9d"]

describe("Task 097 PROJECT Yeonjang Skill MCP evidence", () => {
  it("proves exact Yeonjang, active Skill, and isolated MCP means", () => {
