...
const requirementIds = ["PRJ-81dad113", "PRJ-a3d03f6d", "PRJ-4694deef"]

describe("Task 086 PROJECT failure recovery readiness evidence", () => {
  it("proves unsatisfied criteria, obtained evidence, and safe executable next action", () => {
