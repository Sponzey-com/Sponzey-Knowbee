...
const requirementIds = ["PRJ-3ed012eb", "PRJ-57811440", "PRJ-bf3f2e4a"]

describe("Task 084 PROJECT capability selection criteria evidence", () => {
  it("proves role, permission, side-effect, and evidence-quality comparison", () => {
