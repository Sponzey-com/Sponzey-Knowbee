...
const requirementIds = ["PRJ-8f0ecb99", "PRJ-c6cae155", "PRJ-d0805cec"]

describe("Task 090 PROJECT minimum execution model evidence", () => {
  it("proves direct sequential simplicity and complete analyzed-step execution", () => {
