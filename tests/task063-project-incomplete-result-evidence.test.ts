...
const REQUIREMENTS = ["PRJ-fad6c43e", "PRJ-42b4a4ab", "PRJ-424aafb1"] as const

describe("Task 063 PROJECT incomplete-result evidence", () => {
  it("proves that incomplete evidence and receipt-only success cannot complete work", () => {
    ...
    expect(result.audit.counts.proven).toBeGreaterThanOrEqual(35)
    expect(result.audit.counts.missing).toBeLessThanOrEqual(134)
