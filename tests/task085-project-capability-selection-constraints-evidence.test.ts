...
const requirementIds = ["PRJ-1ada0ba9", "PRJ-6bbe731c", "PRJ-1735e651"]

describe("Task 085 PROJECT capability selection constraint evidence", () => {
  it("proves structured comparison, privacy/cost constraints, and changed strategy", () => {
