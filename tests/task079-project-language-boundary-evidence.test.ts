...
const requirementIds = ["PRJ-541031c2", "PRJ-f0286559", "PRJ-d1e8369c"]

describe("Task 079 PROJECT language boundary evidence", () => {
  it("proves English system prompts and request-language LLM responses", () => {
    ...
    expect(result.audit.counts.proven).toBeGreaterThanOrEqual(76)
    expect(result.audit.counts.missing).toBeLessThanOrEqual(93)
