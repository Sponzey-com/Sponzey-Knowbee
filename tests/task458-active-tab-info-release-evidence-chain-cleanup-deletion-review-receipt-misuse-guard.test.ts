...
function cleanupDeletionReviewReceipt() {
...
describe("task458 active tab info release evidence chain cleanup deletion review receipt misuse guard", () => {
  it("rejects approval evidence that tries to carry cleanup deletion review receipt state", () => {
    const manifest = buildReleaseManifest({
      rootDir: process.cwd(),
      now: new Date("2026-07-23T17:40:00.000Z"),
  ...
  it("does not accept cleanup deletion review receipt as final response or product log evidence", () => {
