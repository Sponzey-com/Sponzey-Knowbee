...
const REQUIREMENTS = ["PRJ-05b2079e", "PRJ-3e968157", "PRJ-1ea7f587"] as const

describe("Task 070 PROJECT LLM failure diagnosis evidence", () => {
  it("proves structured failure cause diagnosis and corrective changed dimensions", () => {
    ...
    expect(result.audit.counts.proven).toBeGreaterThanOrEqual(55)
    expect(result.audit.counts.missing).toBeLessThanOrEqual(114)
