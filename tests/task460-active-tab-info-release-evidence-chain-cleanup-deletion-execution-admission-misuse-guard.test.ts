...
function cleanupDeletionExecutionAdmission() {
...
describe("task460 active tab info release evidence chain cleanup deletion execution admission misuse guard", () => {
  it("rejects approval evidence that tries to carry cleanup deletion execution admission state", () => {
    const manifest = buildReleaseManifest({
      rootDir: process.cwd(),
      now: new Date("2026-07-23T17:50:00.000Z"),
  ...
  it("does not accept cleanup deletion execution admission as final response or product log evidence", () => {
