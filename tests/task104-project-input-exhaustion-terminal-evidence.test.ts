...
const requirementIds = ["PRJ-124cdd26", "PRJ-2fc0158d", "PRJ-fdd141a6"]

describe("Task 104 PROJECT input exhaustion and terminal evidence", () => {
  it("proves exact input waiting, path exhaustion, and canonical termination conditions", () => {
